...
const Aboutus = () => {
    return (
        ...
        <div id="aboutus-section">
            <div className='mx-auto max-w-7xl px-4 py-24 my-32 lg:px-10 bg-rose-300 rounded-3xl relative'>
                <Image src="/assets/aboutus/dots.svg" width={100} height={100} alt="dots-image" className="absolute bottom-1 -left-20" />
                <h3 className='text-center text-slate-600 text-lg tracking-widest'>ABOUT US</h3>
                <h4 className='text-center text-6xl text-slate-800 lg:text-65xl font-bold'>Know more about us.</h4>
