...
const postData: DataType[] = [
    {
        ...
        name: 'AihubPro',
        imgSrc: '/assets/teacher/user3.png',
    },
    {
        profession: 'Senior UX Designer',
        name: 'AihubPro',
        imgSrc: '/assets/teacher/user2.png',
    },
    {
        profession: 'Senior UX Designer',
        name: 'AihubPro',
        imgSrc: '/assets/teacher/user1.png',
    },
    {
        profession: 'Senior UX Designer',
        name: 'AihubPro',
...
export default class MultipleItems extends Component {
    ...
    render() {
        ...
        return (
            <div className="py-10 sm:py-24 bg-paleblue" id="teacher">

                <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 px-4 lg:px-8 relative'>
                    <h2 className="lh-82 text-blue-900 text-5xl md:text-55xl text-center md:text-start font-semibold">From Geek to Guru: Elevate Your Tech Journey.</h2>
                                ...
                                <div className='m-3 py-14 md:my-10 text-center'>
                                    <div className="relative">
                                        ...
                                        <div className="absolute right-[84px] bottom-[102px] bg-white rounded-full p-4">
                                            <Image src={'/assets/teacher/linkedin.svg'} alt="linkedin-image" width={25} height={24} />
                                        </div>
                                    </div>
                                    <div className="-mt-10">
