            ...
            <div id="courses">
                <div className='mx-auto max-w-7xl sm:py-8 px-4 lg:px-8 '>
                    ...
                    <div className="sm:flex justify-between items-center">
                        ...
                        <Link href={'/'} className="text-teal-950 text-lg font-medium space-links">Explore courses&nbsp;&gt;&nbsp;</Link>
                    </div>
                            ...
                            <div key={i}>
                                ...
                                <div className='bg-white m-3 px-3 pt-3 pb-12 my-20 shadow-courses rounded-2xl'>
                                    <div className="relative rounded-3xl">
                                        ...
                                        <div className="absolute right-5 -bottom-2 bg-blue-300 rounded-full p-6">
                                            <h3 className="text-blue-950 uppercase text-center text-sm font-medium">best <br /> seller</h3>
                                        </div>
                                    </div>
